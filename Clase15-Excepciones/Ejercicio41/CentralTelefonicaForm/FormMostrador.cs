    ...
    {        
        ...
        public Llamada.TipoLlamada TipoLlamada
        {
            set
            {
                ...
                {
                    richTextBox1.Text = "Ganancia Local: " + centralita.GananciaPorLocal.ToString("0.00");
                }                
                else if(tipoLlamada == Llamada.TipoLlamada.Provincial)
                {
                    richTextBox1.Text = "Ganancia Provincial: " + centralita.GananciaPorProvincial.ToString("0.00");
                }
                else
                {
                    richTextBox1.Text = "Ganancia total: " + centralita.GananciaPorTotal.ToString("0.00");
                }
            }
        }
