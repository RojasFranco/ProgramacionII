...
namespace _20191121_SP
{
    public partial class FrmSistemaSolar : Form
    {
        ...
        public delegate void Callback(object sender, PlanetaEventArgs e);
        ...
        private void btnSimular_Click(object sender, EventArgs e)
        {
            if(this.animaciones.Count == 0)
            {
                ...
                {
                    Thread hilo = new Thread(new ThreadStart(planeta.AnimarSistemaSolar));
                    this.animaciones.Add(hilo);
                    hilo.Start();
                }
                this.btnSimular.Text = "Detener";
                this.Text = this.btnSimular.Text.EstadoSimulacion(true);
            ...
            else
            {
                ...
                this.Text = this.btnSimular.Text.EstadoSimulacion(false);
            }
        }
